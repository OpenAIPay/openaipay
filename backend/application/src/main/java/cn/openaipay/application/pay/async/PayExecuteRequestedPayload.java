 ...
 * @date: 2026/03/14
 */
public record PayExecuteRequestedPayload(
    /** 支付单号 */
    String payOrderNo
) {
     ...
     * 处理业务数据。
     */
    public static PayExecuteRequestedPayload fromPayload(String payload) {
        Map<String, Object> raw = JsonParserFactory.getJsonParser().parseMap(payload);
        Object value = raw.get("payOrderNo");
        return new PayExecuteRequestedPayload(value == null ? null : String.valueOf(value));
    }
}
